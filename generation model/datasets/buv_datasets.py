...
class BUV(torch.utils.data.Dataset):
    """Load the BUV video files
    ...
    def __getitem__(self, index):
        ...
        # print(start_frame_ind, end_frame_ind, )
        assert end_frame_ind - start_frame_ind >= self.target_video_len
        frame_indice = np.linspace(start_frame_ind, end_frame_ind-1, self.target_video_len, dtype=int)
        # print(frame_indice)
        video = vframes[frame_indice] #
        video = self.transform(video) # T C H W
        # print(path,class_index)
...
if __name__ == '__main__':
    ...
    # parser.add_argument("--data-path", type=str, default="/nvme/share_data/datasets/BUV/videos")
    parser.add_argument("--data-path", type=str, default="/home/extradisk/liuyaofang/datasets/Miccai_2022_BUV_Dataset/rawvideos")
    ...
    ffs_dataset = BUV(config, transform=transform_BUV, temporal_sample=temporal_sample)
